...
"")
        ...
        self.label_method_back = QtGui.QLabel(self.method_page)
        self.label_method_back.setEnabled(True)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_method_back.sizePolicy().hasHeightForWidth())
        self.label_method_back.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setUnderline(False)
        self.label_method_back.setFont(font)
        self.label_method_back.setObjectName("label_method_back")
        self.verticalLayout82.addWidget(self.label_method_back)
        self.label_3 = QtGui.QLabel(self.method_page)
        ...
        self.verticalLayout82.addWidget(self.label_3)
        self.groupBox_3 = QtGui.QGroupBox(self.method_page)
...
"")
        ...
        self.verticalLayout82.addWidget(self.groupBox_3)
        self.groupBox_4 = QtGui.QGroupBox(self.method_page)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pushButton_2.setStyleSheet("color: rgb(248, 248, 248);\n"
"background-color: rgb(35, 165, 225);\n"
"border: 0px;\n"
"")
        self.pushButton_2.setObjectName("pushButton_2")
        self.horizontalLayout_6.addWidget(self.pushButton_2)
        self.verticalLayout82.addWidget(self.groupBox_4)
        self.groupBox_5 = QtGui.QGroupBox(self.method_page)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pushButton_3.setStyleSheet("color: rgb(248, 248, 248);\n"
"background-color: rgb(35, 165, 225);\n"
"border: 0px;\n"
"")
        self.pushButton_3.setObjectName("pushButton_3")
        self.horizontalLayout_7.addWidget(self.pushButton_3)
        self.verticalLayout82.addWidget(self.groupBox_5)
    ...
    def retranslateUi(self, LoginDialog):
        ...
        self.label_method_back.setToolTip(QtGui.QApplication.translate("LoginDialog", "Return to the login window", None, QtGui.QApplication.UnicodeUTF8))
        self.label_method_back.setText(QtGui.QApplication.translate("LoginDialog", "<html><head/><body><p><a href=\"#\"><span style=\" text-decoration: underline; color:#c0c1c3;\">Go back</span></a></p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate("LoginDialog", "A default authentication can be set for the next time you log in by click on the options", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_3.setTitle(QtGui.QApplication.translate("LoginDialog", "Local browser", None, QtGui.QApplication.UnicodeUTF8))
        self.label1.setText(QtGui.QApplication.translate("LoginDialog", "<html><head/><body><p>A good description of this authentication method.<br/>This is the recommanded method.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton.setText(QtGui.QApplication.translate("LoginDialog", "Launch browser", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_4.setTitle(QtGui.QApplication.translate("LoginDialog", "Web login", None, QtGui.QApplication.UnicodeUTF8))
        self.label_21.setText(QtGui.QApplication.translate("LoginDialog", "Selecting this method, you will be prompted for login credentials from inside an internal web browser", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_2.setText(QtGui.QApplication.translate("LoginDialog", "Launch browser", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_5.setTitle(QtGui.QApplication.translate("LoginDialog", "Login credentials", None, QtGui.QApplication.UnicodeUTF8))
        self.label_4.setText(QtGui.QApplication.translate("LoginDialog", "This is the legacy authentication using a login, a password. And potentially a two-factor authentication.", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_3.setText(QtGui.QApplication.translate("LoginDialog", "Enter login credentials", None, QtGui.QApplication.UnicodeUTF8))
